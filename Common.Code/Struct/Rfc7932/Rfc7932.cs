...
namespace Libraries.Struct.Rfc7932 {
	/// <summary>
	/// RFC7932(Brotli Compressed Data Format)処理クラスです。
	/// </summary>
	public static class Rfc7932 {
		...
		public static void Decode(Stream writer, Stream reader) {
			using (var action = new BrotliStream(reader, CompressionMode.Decompress)) {
